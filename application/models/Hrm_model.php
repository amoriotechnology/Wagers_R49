...
public function fristmonth($quarter)
{
     $currentYear = date('Y');
     $user_id = $this->session->userdata('user_id');
   ...
   $this->db->select(
    'SUM(a.hourly) as hourly_amount, 
     ...
     $this->db->where('b.create_by', $user_id); // Ensure you reference the correct table alias 
...
public function secondmonth($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
...
public function thirdmonth($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
     $this->db->select(
...
public function fourth($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
     $this->db->select(
...
public function seventh($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
     $this->db->select(
...
public function eleventh($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
     $this->db->select(
...
public function twelfth($quarter)
{
    $currentYear = date('Y');
    $user_id = $this->session->userdata('user_id');
     $this->db->select(
