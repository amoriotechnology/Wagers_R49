...
public function formnj927($quarter = null)
{
    ...
    //  print_r( $data['info_for_nj']);
     ...
     $data['fristmonth'] = $this->Hrm_model->fristmonth($quarter);
     $data['secondmonth'] = $this->Hrm_model->secondmonth($quarter);
     $data['thirdmonth'] = $this->Hrm_model->thirdmonth($quarter);
     $data['fourth'] = $this->Hrm_model->fourth($quarter);
     $data['fifth'] = $this->Hrm_model->fifth($quarter);
     $data['sixth'] = $this->Hrm_model->sixth($quarter);
     $data['seventh'] = $this->Hrm_model->seventh($quarter);
     $data['eigth'] = $this->Hrm_model->eigth($quarter);
     $data['ninth'] = $this->Hrm_model->ninth($quarter);
     $data['tenth'] = $this->Hrm_model->tenth($quarter);
     $data['eleventh'] = $this->Hrm_model->eleventh($quarter);
     $data['twelfth'] = $this->Hrm_model->twelfth($quarter);
...
//print_r($state_summary_employer);die();
   ...
   // print_r($employer_contributions);die();
